package com.example.guilianghuang.testgradle.recyclerview.refreshLoad;
...
import com.example.guilianghuang.testgradle.recyclerview.widget.LoadViewCreator;
...
public class DefaultLoadCreator extends LoadViewCreator {
    ...
    public void onPull(int currentDragHeight, int refreshViewHeight, int currentRefreshStatus) {
        if (currentRefreshStatus == LoaderRefreshRecyclerView.LOAD_STATUS_PULL_DOWN_REFRESH) {
            mLoadTv.setText("上拉加载更多");
        }
        if (currentRefreshStatus == LoaderRefreshRecyclerView.LOAD_STATUS_LOOSEN_LOADING) {
